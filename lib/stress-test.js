const puppeteer = require("puppeteer"); // Use puppeteer-firefox if you installed puppeteer-firefox
...
async function start(
  ...
  const [browser, meetingPassword] = await Promise.all([
    puppeteer.launch({
      product: 'firefox', // This tells Puppeteer to launch Firefox instead of Chrome
      headless: true,
      args: [
